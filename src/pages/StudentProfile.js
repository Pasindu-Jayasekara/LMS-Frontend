...
import {
    FaUserGraduate, FaEnvelope, FaPhone, FaLock, FaSave,
    FaBook, FaEye, FaEyeSlash
} from 'react-icons/fa';
import Sidebar from '../components/Sidebar';

const StudentProfile = () => {
    // Read student ID from sessionStorage
    const studentId = sessionStorage.getItem('userId') || 'S9851'; // fallback just in case
    ...
    const handleSaveProfile = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://localhost:5000/api/student/profile/update-info/${studentId}`, {
                first_name: profileData.first_name,
                last_name: profileData.last_name,
                email: profileData.email,
                contact: profileData.contact
            }); // Intentionally omitting grade to prevent student tampering
    ...
    const handleUpdatePassword = async (e) => {
        ...
        try {
            await axios.put(`http://localhost:5000/api/student/profile/update-password/${studentId}`, {
    ...
    const initials = `${profileData.first_name.charAt(0)}${profileData.last_name.charAt(0)}`.toUpperCase() || 'S';
                ...
                <div style={styles.content}>
                    ...
                    <div style={styles.pageHeader}>
                        <h2 style={styles.pageTitle}>
                            <FaUserGraduate style={{ marginRight: 10, color: '#2563EB' }} /> Student Profile
                        </h2>
                        ...
                        <div style={styles.card}>
                            ...
                            <div style={styles.avatarSection}>
                                ...
                                <div>
                                    ...
                                    <span style={styles.roleBadge}>{profileData.grade || 'Student'}</span>
                                </div>
                            </div>
                            ...
                            <form onSubmit={handleSaveProfile} style={styles.form}>
                                ...
                                {/* Grade (Read-Only) */}
                                <div style={styles.inputGroup}>
                                    <label style={styles.label}>Grade / Batch</label>
                                    <div style={styles.inputWrapper}>
                                        <FaBook style={styles.inputIcon} />
                                        <input
                                            type="text"
                                            name="grade"
                                            value={profileData.grade}
                                            style={{ ...styles.inputWithIcon, backgroundColor: '#E5E7EB', color: '#6B7280', cursor: 'not-allowed' }}
                                            placeholder="Grade/Batch"
                                            disabled
                                            readOnly
                                        />
                                    </div>
